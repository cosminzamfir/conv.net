...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in xrange(num_test):
            #print('Computing distances for test image',i)
    ...
    def compute_distances_no_loops(self, X):
        ...
        return np.sqrt(-2*test_dot_train + test_dot_test.reshape((num_test, 1)) + train_dot_train)
    ...
    def predict_labels(self, dists, k=1):
        ...
        y_pred = np.zeros(num_test)  # A list of length k storing the labels of the k nearest neighbors to
        # the ith test point.
        closest_y = []
        #########################################################################
        # TODO:                                                                 #
        ...
        # label.                                                                #
        #########################################################################
        y_pred = np.apply_along_axis(mode, 1, closest_y)[:, 0]
        return y_pred
